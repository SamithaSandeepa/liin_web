...
const programComponents = [
  {
    ...
    description:
      "Advances visibility of women in business leadership, shares success stories, and discusses creating a female network of impact investors, mentors, and social entrepreneurs. The inaugural summit attracted over 100 stakeholders and is expanding island-wide.",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Pairs emerging entrepreneurs with established professionals to provide guidance during early business stages.",
    icon: Handshake,
  },
];
  ...
  return (
    <>
      <HeroSection
        ...
        backgroundImage="/images/projects/empowering_women/cover.JPG"
      />

      {/* Quote & Introduction */}
      <Section id="introduction" title="Our Vision">
          ...
          <div className="animate-on-scroll">
            <div className="bg-gradient-to-br from-primary/5 to-secondary/5 p-8 rounded-2xl border-l-4 border-primary mb-8">
              <blockquote className="text-xl md:text-2xl text-gray-700 italic text-center">
                &ldquo;Just like the lotus, we too have the ability to rise from
                the mud, bloom out of the darkness and radiate into the
                world&rdquo;
              </blockquote>
            </div>
          </div>
          <div className="animate-on-scroll">
            <div className="bg-white p-8 rounded-2xl shadow-medium">
              <p className="text-lg text-gray-700 leading-relaxed">
                LIIN believes entrepreneurship can economically empower women
                and generate inclusive growth in Sri Lanka&apos;s labor force.
                The Emerging Women initiative aims to foster an ecosystem
                supporting women&apos;s participation in enterprise development,
                creating pathways for success and sustainable impact.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Program Components */}
      <Section id="programs" title="Program Components" background="gray">
        <div className="max-w-4xl mx-auto">
      ...
      {/* Focus Areas */}
      <Section id="focus-areas" title="Key Focus Areas">
      ...
      {/* Impact Stats */}
      <Section id="impact" title="Our Impact" background="gray">
